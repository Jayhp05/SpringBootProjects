...
public class BoardRestController {
	...
	/* 게시글 리스트 Get 요청을 처리하는 메서드
	 * 
	 */
	@GetMapping({"/boards/", "/board/{pageNum}"})
	public ResponseEntity<Map<String, Object>> boardList(Model model, 
